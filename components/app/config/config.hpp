...
namespace config {
    ...
    constexpr inline const char GCODE_FILE_BASE_PATH[]       = "/device/file.gcode";
    constexpr inline const char INDEX_HTML_FILE_BASE_PATH[]  = "/device/index.html";
    constexpr inline const char WIFI_SSID_NAME[]             = "ESP-Pen-Plotter";

    constexpr inline uint8_t MAX_WIFI_CONNECTIONS            = 4;
    constexpr inline uint32_t MAX_FILE_SIZE_BYTES            = 2 * 1024 * 1024;
